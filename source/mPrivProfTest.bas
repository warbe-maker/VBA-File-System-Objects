...
' ----------------------------------------------------------------------------
    ...
    mPrivProfTest.Test_89_FileName
    mPrivProfTest.Test_90_IsValidFileFullName
    mPrivProfTest.Test_91_PrivateProfile_SectionsNames
    mPrivProfTest.Test_92_PrivateProfile_ValueNames
    mPrivProfTest.Test_93_PrivateProfile_Value
    mPrivProfTest.Test_94_PrivateProfile_Values
    mPrivProfTest.Test_96_PrivateProfile_Entry_Exists
    mPrivProfTest.Test_97_PrivateProfile_SectionsCopy
    mPrivProfTest.Test_98_PrivateProfile_Reorg
    mPrivProfTest.Test_99_PrivateProfile_Reorg_WithNoFileProvided
